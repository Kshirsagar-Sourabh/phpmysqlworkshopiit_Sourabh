...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $existSql = "SELECT * FROM `users10`.`users` WHERE username = '$username'";
    ...
    if($numExistRows > 0){
        ...
        if(($password == $cpassword)){
            ...
            $sql = "INSERT INTO `users10`.`users` ( `username`, `password`, `dt`) VALUES ('$username', '$password', current_timestamp())";
